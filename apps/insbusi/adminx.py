...
class InserNewOrgInfoInline(object):
    ...
    # readonly_fields = ['insert_datetime', 'log_txt']
    extra = 0


class InserNewOrgInfoAdmin(object):
    list_display = ['org_code', 'insert_org_flag' ,'org_fname','sfc_code','sse_code','sza_ic','sza_unit','sha_ic','sha_unit','central_org']
